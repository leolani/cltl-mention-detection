...
from cltl.mention_detection.dummy_demo import DummyDemoProcessor
...
from cltl_service.mention_detection.service import TemplateService
...
class ApplicationContainer(ThreadedResourceContainer, K8LocalConfigurationContainer):
    ...
    @singleton
    def processor(self):
        config = self.config_manager.get_config("cltl.mention-detection")
